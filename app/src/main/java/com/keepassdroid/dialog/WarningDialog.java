...
public class WarningDialog extends AlertDialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setButton(AlertDialog.BUTTON1, ctx.getText(android.R.string.ok), new OnClickListener() {
		...
		setButton(AlertDialog.BUTTON2, ctx.getText(R.string.beta_dontask), new OnClickListener() {
